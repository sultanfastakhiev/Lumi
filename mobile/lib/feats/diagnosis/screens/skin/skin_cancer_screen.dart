  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => BasePredictionCubit(
        endpoint: locator<PredictSkinCancerEndpoint>(),
        pushResultPage: (image, predictions) {
          AutoRouter.of(context).push(SkinCancerResultsScreenRoute(image: image, predictions: predictions));
        },
      ),
      child: EmptyLayout(
        child: ListView(
          children: [
            ...
            const PageSubtitle("Автоматическая диагностика рака кожи по фотографии опухоли"),
