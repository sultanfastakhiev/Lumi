  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => BasePredictionCubit(
        endpoint: locator<PredictBrainTumorsEndpoint>(),
        pushResultPage: (image, predictions) {
          AutoRouter.of(context).push(BrainTumorsResultsScreenRoute(image: image, predictions: predictions));
        },
      ),
      child: EmptyLayout(
        child: ListView(
          children: [
            ...
            const PageSubtitle("Автоматическая диагностика злокачественных опухолей по МРТ головного мозга"),
